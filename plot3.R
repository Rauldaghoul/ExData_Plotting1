#Exploratory Data Analysis: Course Project - plot3 R script
...
#We now create and save the plot, which in this case is a line graph with multiple series representing the different metering types, each of a different color.
#It also has a legend in which each series is represented.
